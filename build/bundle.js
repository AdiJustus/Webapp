(function () {
    ...
    prices[clothingTypes.TShirt];
    prices[clothingTypes.TShirt];

    let price = document.getElementById("result");
    document.getElementsByClassName("clothing");
    document.getElementsByClassName("sizeSelection");
    document.querySelectorAll(".colorField");
    ...
    function output(e) {
        ...
        if (typeOfClothing === clothingTypes.TShirt) {
            const tshirt = document.querySelector("#previewBox");
            tshirt.style.display = "inline";
            chosenClothing = 0;
        }
        else if (typeOfClothing === clothingTypes.Shirt) {
            const shirt = document.querySelector("#previewBox2");
            shirt.style.display = "inline";
            chosenClothing = 1;
        }
        else if (typeOfClothing === clothingTypes.Hoodie) {
            const hoodie = document.querySelector("#previewBox3");
            hoodie.style.display = "inline";
            chosenClothing = 2;
        }
        else if (typeOfClothing === clothingTypes.Sweater) {
            const sweater = document.querySelector("#previewBox4");
