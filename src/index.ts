...
function warenkorbHinzufuegen() {
    ...
    if (kleidung === 'T-Shirt') {
        cont!.innerHTML = `<svg version="1.1" id="i1" class="svgs2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 407.7 407.7" style="enable-background:new 0 0 407.7 407.7;" xml:space="preserve">
    <g>
        <g>
            <path id="inlinePath" fill= "${farbe}" d="M405.5,118.021c-0.094-0.099-0.191-0.196-0.29-0.29l-84.16-74.8c-0.768-0.7-1.664-1.243-2.64-1.6l-60.88-21.76
