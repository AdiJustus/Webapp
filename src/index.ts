...
const preiseGroesse: number[] = [10, 20, 30, 40, 50, 60];
...
function warenkorbHinzufuegen() {
    ...
    if (kleidung === 'T-Shirt') {
        cont!.innerHTML = `<svg version="1.1" id="i1" class="svgs" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
