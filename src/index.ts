...
import { sizeSelector, materialSelector, price, shoppingCartList, shoppingCartButton, sizeChartButton, resetButton, addToCartButton, overlay } from "./dom-utils";

let chosenClothing: number;
const priceClothing: number[] = [10, 15, 20, 30, 40, 50];
const priceSize: number[] = [1, 2, 3, 4, 5, 6];
const priceMaterial: number[] = [10, 20, 30, 40, 50, 60];
