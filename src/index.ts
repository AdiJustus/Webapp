...
const warenkorbListe = document.getElementById("Warenkorb");
const sizeSelector = document.getElementById("sizeSelector") as HTMLSelectElement;
const materialSelector = document.getElementById("materialSelector") as HTMLSelectElement;
let preis = document.getElementById("Ergebnis");

let ausgewaehlteKleidung: number;
const preiseKleidung: number[] = [10, 20, 30, 40, 50, 60];
const preiseGroesse: number[] = [5, 5, 10, 10, 15, 15];
const preiseMaterial: number[] = [10, 20, 30, 40, 50, 60];

var kleidung: string;
var letztePreis: number = 0;
var farbe: string = "black";
var warenkorb = [];
...
function groesseAuswahl() {
  preisAnzeigen();
}

function materialAuswahl() {
  preisAnzeigen();
}
...
function preisAnzeigen() {
  ...
  letztePreis += preiseKleidung[ausgewaehlteKleidung];

  letztePreis += preiseGroesse[sizeSelector.selectedIndex];

  letztePreis += preiseMaterial[materialSelector.selectedIndex];

  preis!.innerHTML = "Preis: " + letztePreis + "€";
}
