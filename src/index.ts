...
const priceMaterial: number[] = [20, 10, 5, 40, 50, 60];

var clothes: string;
var lastPrice: number = 0;
var giveColor: string = "black";
var shoppingCart = [];
...
function output(typeOfClothing: string): void {
  hideElements();

  clothes = typeOfClothing;

  if (typeOfClothing === "T-Shirt") {
    const tshirt = document.querySelector("#previewBox") as HTMLElement;

    tshirt!.style.display = "inline";

    chosenClothing = 0;
  } else if (typeOfClothing === "Shirt") {
    const shirt = document.querySelector("#previewBox2") as HTMLElement;

    shirt!.style.display = "inline";

    chosenClothing = 1;
  } else if (typeOfClothing === "Hoodie") {
    const hoodie = document.querySelector("#previewBox3") as HTMLElement;

    hoodie!.style.display = "inline";

    chosenClothing = 2;
  } else if (typeOfClothing === "Sweater") {
    const sweater = document.querySelector("#previewBox4") as HTMLElement;
